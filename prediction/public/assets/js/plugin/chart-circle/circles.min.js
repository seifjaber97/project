        ...
        (b.prototype = {
            ...
            _generateText: function () {
                if (((this._textContainer = document.createElement("div")), (this._textContainer.className = this._textClass), this._styleText)) {
                    var a = { position: "absolute", top: 0, left: 0, textAlign: "center", width: "100%", fontSize: 0.7 * this._radius + "px", height: this._svgSize + "px", lineHeight: this._svgSize + "px" };
            ...
            _arc: function (a, b) {
                ...
                return [
                    ...
                    d,
                    1,
                    this._radius + this._radiusAdjusted * Math.cos(c),
                    this._radius + this._radiusAdjusted * Math.sin(c),
                    b ? "" : "Z",
                ].join(" ");
            },
            _precise: function (a) {
